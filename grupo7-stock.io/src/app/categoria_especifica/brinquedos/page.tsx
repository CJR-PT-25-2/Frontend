    ...
    <>
      ...
      <div className="flex justify-center items-center h-65 bg-[#000000] text-white">
        <div className="text-white text-right pr-5">
          ...
          <h1 className="text-4xl leading-snug pb-10">em um só lugar!</h1>
        </div>
      ...
      <div className="relative z-10 bg-[#F6F3E4] h-full min-h-130 pl-10 pt-10">
        {/* Barra de Pesquisa */}
        ...
        <div className="flex space-x-8 items-center overflow-x-auto whitespace-nowrap">
          ...
          <button
            ...
            className={`h-10 w-18 rounded-2xl hover:scale-105 cursor-pointer px-10 flex items-center justify-center ${
              filtroAtivoId === 16
                ? "bg-[#982829] text-white font-bold  "
                : "text-[#982829] bg-white"
            }`}
          ...
          <button
            ...
            className={`h-10 w-22 rounded-2xl hover:scale-105 cursor-pointer px-10 flex items-center justify-center ${
              filtroAtivoId === 17
                ? "bg-[#982829] text-white font-bold  "
                : "text-[#982829] bg-white"
            }`}
