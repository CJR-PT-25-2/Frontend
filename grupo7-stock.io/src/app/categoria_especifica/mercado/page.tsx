...
export default function FeedPage() {
  ...
  const [produtosGeraisMercado, setProdutosGeraisMercado] = useState<
    ProdutoParacard[]
  >([]);
  ...
  const [produtosFiltradosBuscaCategoria, setProdutosFiltradosBuscaCategoria] =
    useState<ProdutoParacard[]>([]);
    ...
    <>
      ...
      <div className="flex justify-center items-center h-65 bg-[#000000] text-white">
        <div className="text-white">
          ...
          <h1 className="text-4xl leading-snug pl-55 pb-10">em um só lugar!</h1>
        </div>
      ...
      <div className="relative z-10 bg-[#F6F3E4] h-full min-h-150 pl-10 pt-10">
        ...
        <div className="flex space-x-8 items-center overflow-x-auto whitespace-nowrap">
          ...
          <button
            ...
            className={`h-10 w-21  rounded-2xl hover:scale-105 cursor-pointer px-10 flex items-center justify-center ${
              filtroAtivoId === 6
                ? "bg-[#982829] text-white font-bold  "
                : "text-[#982829] bg-white"
            }`}
