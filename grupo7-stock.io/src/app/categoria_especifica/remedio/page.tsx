    ...
    return (
        ...
        <div className=" relative z-10 bg-[#F6F3E4] h-300  pl-10 pt-10 ">
          ...
          <div className=" flex space-x-8  items-center   overflow-x-auto whitespace-nowrap">
            ...
            < button className=" h-10 w-35 text-[#982829] bg-white  rounded-2xl hover:scale-105 cursor-pointer pl-10 pr-10 flex items-center justify-center">
                Higiene Pessoal
            </button>
            < button className=" h-10 w-30 text-[#982829] bg-white rounded-2xl hover:scale-105 cursor-pointer pl-10 pr-10 flex items-center justify-center">
                Medicamentos
            </button>
