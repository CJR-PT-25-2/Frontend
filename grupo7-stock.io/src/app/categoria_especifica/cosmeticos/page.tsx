      ...
      <div className="relative z-10 bg-[#F6F3E4] h-full pl-10 pt-10">
        ...
        <div className="flex space-x-8 items-center overflow-x-auto whitespace-nowrap">
          ...
          <button
            ...
            className={`h-10 w-10 rounded-2xl hover:scale-105 cursor-pointer px-10 flex items-center justify-center ${
              filtroAtivoId === 25
                ? "bg-[#982829] text-white font-bold  "
                : "text-[#982829] bg-white"
            }`}
          ...
          <button
            ...
            className={`h-10 w-28 rounded-2xl hover:scale-105 cursor-pointer px-10 flex items-center justify-center ${
              filtroAtivoId === 23
                ? "bg-[#982829] text-white font-bold  "
                : "text-[#982829] bg-white"
            }`}
