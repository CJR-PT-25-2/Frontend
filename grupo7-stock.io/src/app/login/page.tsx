...
export default function LoginPage() {
  ...
  const handleRecuperarSenha = async (e: React.FormEvent) => {
    ...
    try {
        // Simulação de envio
        // await suaAPI.enviarLinkRecuperacao(emailRecuperacao); 
        ...
        setErroRecuperacao("Erro ao processar a solicitação. Tente novamente.");
    }
  };
    ...
    <div className="flex h-screen bg-[#f4eaa8]">
      ...
      <div className="flex flex-col justify-center items-center w-[40%] pt-13">
        <Image
          ...
          className="mb-8"
        />
        <Image src="/images/moco2.png" alt="boneco" width={330} height={180} />
      </div>
    ...
    {modalAberto && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm"> 
        <div className="bg-[#1C1C1C] text-white p-8 rounded-lg shadow-2xl w-full max-w-sm">
          ...
          <h2 className="text-xl font-semibold mb-4 text-center">Recuperar Senha</h2>
          ...
          <form onSubmit={handleRecuperarSenha}>
            ...
            {erroRecuperacao && (
              <p className="text-red-400 text-xs text-center mb-4">{erroRecuperacao}</p>
            )}
